...
%prep
%setup -q -n pytest-forked-1.2.0
cd %{_builddir}/pytest-forked-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593098336
...
cp %{_builddir}/pytest-forked-1.2.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-forked/cf3eaf29116a37a7d9ba773e776104c067c8e5fc
